...
async function rules(client, argv) {
  if (argv.length === 0) {
    const lsFn = (await import("./ls-FP6I5BJ4.js")).default;
    return lsFn(client, []);
  }
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-FP6I5BJ4.js")).default(client, args);
    case "add":
      return (await import("./add-PFVGXHF2.js")).default(client, args);
    case "inspect":
      return (await import("./rule-inspect-BA25TI3G.js")).default(client, args);
    case "rm":
      return (await import("./rm-5DVLPTLD.js")).default(client, args);
    case "update":
      return (await import("./update-3LTUTJJB.js")).default(client, args);
    default:
